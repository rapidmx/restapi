...
import { AuditLogEntryMongo, MatterMongo, MessageMongo, RetentionPolicyMongo } from "../../mongo.js";

export class RetentionEnforcementJobMongo extends RetentionEnforcementJob<RetentionPolicyMongo, MessageMongo, AuditLogEntryMongo> {
