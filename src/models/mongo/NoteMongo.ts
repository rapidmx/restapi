...
/**
 * Implementation of the `Note` interface for storage in a MongoDB database. If SQL is desired, please use
 * `models.sql.NoteSQL` instead.
 *
...
export class NoteMongo extends BaseMongoEntity implements Note {
    @Column()
    ...
    constructor(other?: Partial<NoteMongo>) {
        super(other);
