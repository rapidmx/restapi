...
export class MailSignatureSQL extends BaseEntity implements MailSignature {
    @Column()
    ...
    constructor(other?: Partial<MailSignatureSQL>) {
        super(other);
